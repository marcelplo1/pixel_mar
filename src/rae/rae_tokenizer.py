...
#TODO: Experiment also with other encoders 
class RaeTokenizer(nn.Module):
    """
        RAE Tokenizer: frozen DINOv2 encoder + frozen RAE decoder.
    """
    def __init__(
        self,
        ...
        eps=1e-5,
        rae_decoder_ckp="./rae_models/rae_decoder/model.pt",
        rae_norm_stats="./rae_models/rae_stats/stat.pt"
    ):
        super().__init__()
        ...
        self.latent_dim = self.encoder.config.hidden_size  # 768
        self.encoder_patch_size = self.encoder.config.patch_size  # 14
        self.num_patches = (encoder_input_size // self.encoder_patch_size) ** 2  # 256
